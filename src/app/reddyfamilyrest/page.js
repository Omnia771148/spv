...
import './reddyfamilyrest.css';

export default function ReddyFamilyRestMenuLite() {
  ...
  // ID "4" corresponds to Reddy Family Rest
  ...
  const addToCart = (item) => {
    ...
    item.restaurantName = "Reddy Family Restuarent";
  ...
  return (
    <div className="kushas-page container mt-4">
      ...
      <div className="mb-4">
        <RestorentDisplay
          data={restuarents.find(r => r.id === 4)}
