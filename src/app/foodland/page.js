...
export default function FoodlandMenuList() {
  ...
  const restaurantActive = allStatuses["9"] ?? false;
  ...
  return (
    <div className="restaurant-page-bg container mt-4">
      ...
      {/* ✅ RESTAURANT CARD */}
      <RestorentDisplay data={restuarents.find(r => r.id === 9)} distance={distance} className="col-12 mb-4" />
