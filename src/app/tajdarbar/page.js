...
import './tajdarbar.css';

export default function TajdaarbarMenuList() {
  ...
  const restaurantActive = allStatuses["11"] ?? false;
  ...
  const addToCart = (item) => {
    ...
    item.restaurantName = "Hotel Taj Darbar";
  ...
  return (
    <div className="restaurant-page-bg container mt-4">
      ...
      {/* ✅ RESTAURANT CARD */}
      <RestorentDisplay data={restuarents.find(r => r.id === 11)} distance={distance} className="col-12 mb-4" />
