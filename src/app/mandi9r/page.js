...
export default function Mandi9rMenuList() {
  ...
  const restaurantActive = allStatuses["15"] ?? false;
  ...
  return (
    <div className="restaurant-page-bg container mt-4">
      ...
      {/* ✅ RESTAURANT CARD */}
      <RestorentDisplay data={restuarents.find(r => r.id === 15)} distance={distance} className="col-12 mb-4" />
