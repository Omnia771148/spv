...
export default function TalimpuMenuList() {
  ...
  const restaurantActive = allStatuses["10"] ?? false;
  ...
  const addToCart = (item) => {
    ...
    item.restaurantName = "Talimpu Family Restaurant";
  ...
  return (
    <div className="restaurant-page-bg container mt-4">
      ...
      {/* ✅ RESTAURANT CARD */}
      <RestorentDisplay data={restuarents.find(r => r.id === 10)} distance={distance} className="col-12 mb-4" />
